...
Built for the [gitagent Hackathon](https://hackculture.io/hackathons/gitagent-hackathon) using the [gitagent standard](https://github.com/open-gitagent/gitagent) and [gitclaw SDK](https://github.com/open-gitagent/gitclaw).
